...
function ImageSlider() {
  const slides = [
    { src: '/track-control-arm-big-01.jpg', width: 400, height: 300 },
    { src: '/aup-srkit1_xl.jpg', width: 400, height: 300 },
  ];
  ...
  return (
    <div className=" max-w-[2000px] h-[300px] w-full m-auto py-16 px-4 relative group mb-10">
      ...
      <div className="flex items-center justify-center absolute bottom-4 w-64">
